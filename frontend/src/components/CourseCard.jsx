        ...
        <>
            <div className="col">
                <div className="card rounded-top-0">
                    <img src={`https://res.cloudinary.com/${cloudname}/image/upload/${setContainer3rdWidth("ar_16:9,c_fill,g_face,")}/Fnmilove%20Academy/${img}`} className="card-img-top rounded-0" alt="..." />
