...
const Testimonial = () => {
    ...
    return (
        <div className='testimonial-container'>
            ...
            <Carousel fade>
                <Carousel.Item>
                    <img src={`https://res.cloudinary.com/kkenny/image/upload/${setContainerHalfWidth("r_30,ar_3:2,c_fill,g_face,")}/Fnmilove%20Academy/student9`} className='' alt="Academy Student" />
                    <Carousel.Caption>
                        <h2>Caleb Okonkwo</h2>
                ...
                <Carousel.Item>
                    <img src={`https://res.cloudinary.com/kkenny/image/upload/${setContainerHalfWidth("r_30,ar_3:2,c_fill,g_face,")}/Fnmilove%20Academy/face3`} className='' alt="Academy Student" />
                    <Carousel.Caption>
                        <h2>Eliza John</h2>
                ...
                <Carousel.Item>
                    <img src={`https://res.cloudinary.com/kkenny/image/upload/${setContainerHalfWidth("r_30,ar_3:2,c_fill,g_face,")}/Fnmilove%20Academy/student10`} className='' alt="Academy Student" />
                    <Carousel.Caption>
