    ...
    return (
        <div className="team-container">
            ...
            <div className="container">
                <div className="row gy-3 row-cols-1 row-cols-md-2 row-cols-lg-4">
                    <div className="col">
                        <div className='position-relative'>
                            <img src={`https://res.cloudinary.com/kkenny/image/upload/${setContainerQuarterWidth("ar_3:4,")}/v1731513489/Fnmilove%20Academy/face1_rl3dax.png`} alt="" className='img-fluid' />
                    ...
                    <div className="col">
                        <div className='position-relative'>
                            <img src={`https://res.cloudinary.com/kkenny/image/upload/${setContainerQuarterWidth("ar_3:4,")}/v1731513489/Fnmilove%20Academy/face2_tpasfv.png`} alt="" className='img-fluid' />
                            <div className="gap-3 d-flex justify-content-center bg-white social-icons">
                                <a href="" className="text-dark">
                                    <FaFacebookF />
                                </a>
                    ...
                    <div className="col">
                        <div className='position-relative'>
                            <img src={`https://res.cloudinary.com/kkenny/image/upload/${setContainerQuarterWidth("ar_3:4,")}/v1731513489/Fnmilove%20Academy/face3_af6epz.png`} alt="" className='img-fluid' />
                            <div className="gap-3 d-flex justify-content-center bg-white social-icons">
                                <a href="" className="text-dark">
                                    <FaFacebookF />
                                </a>
                    ...
                    <div className="col">
                        <div className='position-relative'>
                            <img src={`https://res.cloudinary.com/kkenny/image/upload/${setContainerQuarterWidth("ar_3:4,")}/v1731513489/Fnmilove%20Academy/face4_z4aeir.png`} alt="" className='img-fluid' />
                            <div className="gap-3 d-flex justify-content-center bg-white social-icons">
                                <a href="" className="text-dark">
                                    <FaFacebookF />
                                </a>
