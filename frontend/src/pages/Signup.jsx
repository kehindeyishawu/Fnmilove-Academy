                ...
                <div className="row g-0">
                    ...
                    <div className="col-md-6 mx-auto">
                        <div className="container-fluid mt-4 mt-lg-3">
                            ...
                            <a href="" className="btn btn-white my-4 my-lg-3 border hstack rounded-0 shadow-sm justify-content-center gap-2">
                        ...
                        <form onSubmit={formSubmit} className="mt-3 mt-lg-2 container-fluid">
                            ...
                            <button className="btn btn-primary py-2 mb-4 mb-lg-3 fw-bold rounded-0 w-100 hstack">
                                <span className="mx-auto">Sign Up</span> <FaArrowRightLong />
                            </button>
                            <div className="text-center form-text">Already have an account? <Link to="/login" className="link-info">Login</Link></div>
                        </form>
                    </div>
                </div>
            </div>
